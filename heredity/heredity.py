...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            # Probabilities of inheriting from the mother
            if mother in two_genes:
                from_mother = 1 - PROBS["mutation"]
            elif mother in one_gene:
                from_mother = 0.5
            elif mother not in one_gene and mother not in two_genes:
                from_mother = PROBS["mutation"]

            # Probabilities of inheriting from the father
            ...
            # Calculate gene probabilities based on the number of genes person has
            if genes == 2:
